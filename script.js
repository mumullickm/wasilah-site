...
const copy = {
  en: {
    heroV3Status: "Live now on Google Play · Free forever",
    ...
    learnTitle: "New to Salah? Wasilah teaches you, step by step.",
    learnText: "The full method of every prayer, and of wudu, taught clearly in Bangla, Arabic and English. The two guides at the heart of Wasilah.",
    learnSalahEyebrow: "Salah Guide",
    learnSalahCap: "Every prayer, step by step.",
    learnWuduEyebrow: "Wudu Guide",
    learnWuduCap: "Ablution, the right way.",
    galleryLabel: "A look inside",
    galleryTitle: "Calm, clear, and made to be read.",
    appstoreLabel: "On iPhone & Android",
    appstoreTitle: "See Wasilah before you install.",
    appstoreText: "The same calm, Bangla-first experience, live on the App Store and Google Play. Built in Bangladesh for Muslims here, and for Bengali families across Saudi Arabia and the Gulf.",
    demoCtaText: "Liked using it here? The full app does all of this offline, on your phone.",
    reasonsLabel: "Why Wasilah",
    reasonsTitle: "Made for Bangladesh, not adapted for it.",
    reasonsSub: "Most Islamic apps treat Bangla as an afterthought. Wasilah is built around it.",
    ethosLabel: "Sadaqah jāriyah",
    ethosTitle: "Share it, and the reward continues.",
    ethosText: "Wasilah is built as a continuing charity. Whoever prays on time, returns to the Quran, or finds the qibla through it carries a reward that keeps giving, for them and for whoever passed it on. If it helps you, share it.",
    ...
    navScreens: "Screens",
    navWhy: "Why Wasilah",
    cinemaSalahEyebrow: "Prayer Times",
    cinemaSalahH: "Never miss a Fajr.",
    cinemaSalahBody: "Accurate Fajr to Isha for your city, with the next prayer always in view and a gentle countdown so you are never caught off guard.",
    cinemaQuranEyebrow: "The Quran",
    cinemaQuranH: "Three languages, side by side.",
    cinemaQuranBody: "Read every ayah in Arabic, English and Bangla together. Beautiful typography, clear translation, nothing in the way of reflection.",
    cinemaQiblaEyebrow: "Qibla",
    cinemaQiblaH: "The right direction, always.",
    cinemaQiblaBody: "A calm, accurate compass that points to the Kaaba from any city, so you can face the right way with confidence.",
    cinemaHadithEyebrow: "Hadith",
    cinemaHadithH: "A hadith to carry through your day.",
    cinemaHadithBody: "Authentic narrations, curated and easy to read, so a little knowledge and a little reminder are always within reach.",
  ...
  bn: {
    heroV3Status: "এখন Google Play-তে · চিরকাল বিনামূল্যে",
    ...
    learnTitle: "নামাজ শিখছেন? ওয়াসিলাহ ধাপে ধাপে শেখায়।",
    learnText: "প্রতিটি নামাজ ও অজুর পূর্ণ পদ্ধতি, বাংলা, আরবি ও ইংরেজিতে স্পষ্টভাবে। ওয়াসিলাহর কেন্দ্রে থাকা দুটি গাইড।",
    learnSalahEyebrow: "নামাজ গাইড",
    learnSalahCap: "প্রতিটি নামাজ, ধাপে ধাপে।",
    learnWuduEyebrow: "অজু গাইড",
    learnWuduCap: "সঠিক নিয়মে অজু।",
    galleryLabel: "ভেতরে এক ঝলক",
    galleryTitle: "শান্ত, স্পষ্ট, পড়ার জন্য তৈরি।",
    appstoreLabel: "iPhone ও Android-এ",
    appstoreTitle: "ইনস্টলের আগে ওয়াসিলাহ দেখে নিন।",
    appstoreText: "একই শান্ত, বাংলা-প্রথম অভিজ্ঞতা, App Store ও Google Play-তে। বাংলাদেশে তৈরি, এখানকার মুসলিমদের জন্য এবং সৌদি আরব ও উপসাগরীয় অঞ্চলে থাকা বাঙালি পরিবারের জন্য।",
    demoCtaText: "এখানে ব্যবহার করে ভালো লাগল? পুরো অ্যাপটি এসবই অফলাইনে, আপনার ফোনে করে।",
    reasonsLabel: "কেন ওয়াসিলাহ",
    reasonsTitle: "বাংলাদেশের জন্য তৈরি, খাপ খাওয়ানো নয়।",
    reasonsSub: "বেশিরভাগ ইসলামিক অ্যাপে বাংলা থাকে শেষ ভাবনায়। ওয়াসিলাহ বাংলাকে ঘিরেই তৈরি।",
    ethosLabel: "সাদাকা জারিয়া",
    ethosTitle: "শেয়ার করুন, সওয়াব চলতে থাকবে।",
    ethosText: "ওয়াসিলাহ একটি চলমান সদকা হিসেবে তৈরি। যিনি এর মাধ্যমে সময়মতো নামাজ পড়েন, কুরআনে ফেরেন বা কিবলা খুঁজে পান, তাঁর জন্য এবং যিনি পৌঁছে দিয়েছেন তাঁর জন্যও সওয়াব চলতে থাকে। কাজে লাগলে শেয়ার করুন।",
    trustFree: "চিরকাল বিনামূল্যে",
    trustNoAds: "কোনো বিজ্ঞাপন নেই",
    trustNoSignup: "সাইন-আপ লাগে না",
    trustOffline: "অফলাইনেও চলে",
    ctaGet: "অ্যাপ নিন",
    navSalah: "নামাজ",
    navQuran: "কুরআন",
    navQibla: "কিবলা",
    navHadith: "হাদিস",
    navTryIt: "চেষ্টা করুন",
    navScreens: "স্ক্রিন",
    navWhy: "কেন ওয়াসিলাহ",
    cinemaSalahEyebrow: "নামাজের সময়",
    cinemaSalahH: "আর কোনো ফজর মিস হবে না।",
    cinemaSalahBody: "আপনার শহরের নির্ভুল ফজর থেকে ইশা; পরবর্তী নামাজ সবসময় চোখের সামনে, সাথে নরম কাউন্টডাউন।",
    cinemaQuranEyebrow: "কুরআন",
    cinemaQuranH: "তিনটি ভাষা, পাশাপাশি।",
    cinemaQuranBody: "প্রতিটি আয়াত আরবি, ইংরেজি ও বাংলায় একসাথে পড়ুন। সুন্দর টাইপোগ্রাফি, পরিষ্কার অনুবাদ, চিন্তায় কোনো বাধা নেই।",
    cinemaQiblaEyebrow: "কিবলা",
    cinemaQiblaH: "সঠিক দিক, সবসময়।",
    cinemaQiblaBody: "শান্ত, নির্ভুল কম্পাস যা যেকোনো শহর থেকে কাবার দিকে নির্দেশ করে।",
    cinemaHadithEyebrow: "হাদিস",
    cinemaHadithH: "দিনভর সঙ্গে রাখার মতো একটি হাদিস।",
    cinemaHadithBody: "সহিহ বর্ণনা, যত্নে বাছাই করা ও সহজে পড়ার মতো, যাতে সামান্য জ্ঞান ও মনে করিয়ে দেওয়া সবসময় কাছে থাকে।",
